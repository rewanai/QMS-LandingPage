  ...
  return (
    <div className={styles.proBlocksFeatureSection}>
      <div className={styles.container}>
          ...
          <div className={styles.grid}>
            <div className={styles.row}>
              <div className={styles.flex}>
                <Image className={styles.iconWrapper} alt="Strategic foundation icon" src="/Icon Wrapper.svg" width={48} height={48} />
              ...
              <div className={styles.flex}>
                <Image className={styles.iconWrapper} alt="Control and awareness icon" src="/Icon Wrapper.svg" width={48} height={48} />
                <div className={styles.flexVertical}>
            ...
            <div className={styles.row}>
              <div className={styles.flex}>
                <Image className={styles.iconWrapper} alt="Measure and analyze icon" src="/Icon Wrapper.svg" width={48} height={48} />
                <div className={styles.flexVertical}>
              ...
              <div className={styles.flex}>
                <Image className={styles.iconWrapper} alt="Plans and actions icon" src="/Icon Wrapper.svg" width={48} height={48} />
                <div className={styles.flexVertical}>
        ...
        <Image className={styles.aspectRatioIcon} alt="FEAT image" src="/FEAT.png" width={500} height={300} />
      </div>
    </div>
  );
};
