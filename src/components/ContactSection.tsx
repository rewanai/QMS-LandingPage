 ...
 * It manages form state, handles user input, and securely sends data
 * to a backend endpoint for processing with the Resend API.
 */
const ProBlocksPricingSection4: FunctionComponent = () => {
  ...
  return (
    <section id="contact" className={styles.proBlocksPricingSection}>
              ...
              <div className={styles.card}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {submissionStatus === 'success' && (
                    <p className={styles.successMessage}>Thank you! Your audit request has been sent successfully.</p>
                  )}
                  ...
                  <button
                    ...
                    disabled={loading}
                  >
                    {loading ? 'Sending...' : 'Schedule a My Free Audit'}
                  </button>
                </form>
...
export default ProBlocksPricingSection4;
